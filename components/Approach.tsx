    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="Мы будем сотрудничать, чтобы определить цели вашего сайта, целевую аудиторию, 
          и ключевые функции. Мы обсудим такие вещи, как структура сайта, 
          навигация и требования к контенту."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            icon={<AceternityIcon  
            order="Фаза 2"/>} 
            description="Как только мы согласуем план, я включаю свой лофи-плейлист и погружаюсь в
            кодирование. От первоначальных набросков до отточенного кода — я буду держать вас в курсе
            каждый шаг пути.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            icon={<AceternityIcon 
            order="Фаза 3"/>}
            description="Вот где происходит волшебство! На основании утвержденного проекта, 
          Переведу все в функциональный код, создаю ваш сайт
          с нуля.">
          <CanvasRevealEffect
            animationSpeed={3}
